...
func466();
function func466(){
    let table = document.querySelector('#t466');
...
func467();
function func467(){
    let table = document.querySelector('#t467');
    let k = 1; 
    for (let i = 0; i < 5; i++) {
        let tr = document.createElement('tr');
...
function func468(){
    ...
    let table = document.getElementById('t468');
...
function func469(){
    ...
    let table = document.getElementById('t469');
...
func470_2();
function func470_1(){
    let table = document.querySelector('#t470_1');
    let tr = document.createElement('tr');
    let button = document.getElementById('b470_1');
    for (let i = 1; i <= 3; i++) {
        let td = document.createElement('td');
        tr.appendChild(td);
    }
...
function func470_2(){
    let table = document.getElementById('t470_2');
    let button = document.getElementById('b470_2');
...
func471();
function func471(){
    let button = document.getElementById('b471');
    button.addEventListener('click',()=>{
        let tds = document.querySelectorAll('#t471 td');
        for (let td of tds) {
            td.textContent *= 2;
        }
    })
...
function func472(){
    ...
    let button = document.getElementById('b472');   
    button.addEventListener('click',()=>{
...
function func474_table(){
    let trs = document.querySelectorAll('#t474 tr')
    for(let tr of trs){
        let remove = document.createElement('a');
        remove.href = '';
...
function func475_inp1(){
    ...
    let input = document.querySelector('#in475');
...
function func477_2(){
    let tds = document.querySelectorAll('#t477 td')
    for(let td of tds){
...
function func479_2(){
   let trs = document.querySelectorAll('#t479_2 tr')
   for(let tr of trs){
...
func483();
function func483(){
    let tds = document.querySelectorAll('#t483 td');
    let color = 'color1';
    for (let td of tds) {
...
func484_2();
function func484_2(){
    let table = document.getElementById('t484_2');
